...
def findcorrelations():
    # input psi file  
    SplicingeventsFile="exp.splicing-filtered.txt"
    ...
    export=open('Tophat_SF_comps_Allevents.txt','w')
    ...
    for exp in lines:
       ...
       # export=open('/Users/meenakshi/Documents/ICGS_guidefiles/Guide3_firstroundicgs-correlations.txt','w')
        ...
        filename=SplicingeventsFile[:-4]+"_"+sfname+"_"+str(count)+"tophat_Allevents.txt"
        if count>20:
