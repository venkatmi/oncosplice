...
class RScripts:
    ...
    def Hopach(self,cluster_method,metric_gene,force_gene,metric_array,force_array):
        ...
        dat = r['data']
        #print_out3=r('data[data==0.000101]<-NA')
        #print_out3=r('data[data==0]<-NA')
        ...
        if cluster_method == 'both' or cluster_method == 'gene':
            distance_matrix_line = 'distmatg<-distancematrix(data,d=%s,na.rm=T)' % metric_g
            #print distance_matrix_line
            if len(dat) > 1:
                print_out1 = r(distance_matrix_line)
                #print_out3=r('data[data==0]<-NA')
                #print_out2=r('packageVersion("hopach")')
                #print print_out2
                ...
                print error; errors.append(error)
        if cluster_method == 'both' or cluster_method == 'array':
            print_out=r['sum(is.na(data))']
            print print_out
            distance_matrix_line = 'distmata<-distancematrix(t(data),d=%s,na.rm=T)' % metric_a
            if len(dat) > 1:
...
if __name__ == '__main__':
    ...
    filename='/Users/meenakshi/Downloads/filteredExp.placentatophat-steady-state.txt'
