...
import ExpandClusters_v3 as ExpandSampleClusters
...
def CompleteWorkflow(InputFile,EventAnnot,turn):
        ...
        if Rank>1:
           ...
           # NMFResult,BinarizedOutput,Metadata,Annotation=NMF_Analysis.NMFAnalysis(NMFinput,Rank,turn)
            ...
            #Guidedir="/Volumes/Pass/FinalDifferential_ALLdata/Events-dPSI_0.1_adjp"
            #PSIdir="/Volumes/Pass/FinalDifferential_ALLdata/ExpressionProfiles"
            ...
            #BinarizedOutput="/Volumes/Pass/FinalDifferential_ALLdata/BinarizedOutput.txt"
            #BinarizedOutput="/Volumes/Pass/KnownClasses/AllAnnotations_T.txt"
           # Guidedir="/Volumes/Pass/ConsolidatedResults/MLL2"
            Guidedir="/Volumes/Pass/Kallisto-Leucegene-MetaDataAnalysis/DEG-LogFold_0.58_adjp-Signatures"
            #PSIdir="/Volumes/Pass/ConsolidatedResults/ExpressionProfiles"
            BinarizedOutput="/Volumes/Pass/MetaData.Analysis/Meta.txt"
...
if __name__ == '__main__':
    ...
    turn=1
    while flag:
        CompleteWorkflow(InputFile,EventAnnot,turn)
        turn+=1
        flag=False
        if flag==False:
            break
